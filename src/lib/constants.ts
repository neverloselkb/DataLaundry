...
export const CLEANING_OPTIONS_SCHEMA: CleaningOptionCategory[] = [
    {
        ...
        label: '기본 정제',
        items: [
            { id: 'autoDetect', label: '스마트 형식 자동 감지', description: '날짜, 금액, 연락처 등 데이터 패턴을 분석하여 적절한 형식을 자동으로 적용합니다.' },
            ...
            { id: 'removeHtml', label: 'HTML 태그 제거', description: '텍스트에 포함된 <p>, <br> 등 HTML 태그를 제거합니다.' },
            { id: 'removeEmoji', label: '이모지/이모티콘 제거', description: '특수 기호 및 이모지를 일괄 제거합니다.' },
            { id: 'toUpperCase', label: '텍스트 대문자 변환', description: '모든 영문 텍스트를 대문자로 일괄 변환합니다.' },
            { id: 'toLowerCase', label: '텍스트 소문자 변환', description: '모든 영문 텍스트를 소문자로 일괄 변환합니다.' },
