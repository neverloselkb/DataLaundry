 ...
 */
export function AdBanner({ slot, format = 'auto', style, className, isTest = false }: AdBannerProps) {
    ...
    return (
        <div
            ...
            style={{ height: '60px', maxHeight: '60px', minHeight: '60px' }} // Wrapper Height Fixed
        >
            <ins
                className="adsbygoogle"
                data-ad-client="ca-pub-0000000000000000"
                data-ad-slot={slot}
                // data-ad-format을 제거하여 고정 크기(style)를 우선시하도록 유도
